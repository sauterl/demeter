...
data class InstagramWebNode(
  ...
  @JsonIgnore
  val ownerId = ownerObj.id
  @JsonIgnore
  val captionText: String? = if (captionObj.edges.isEmpty()) null else captionObj.edges.first().node.text
  @JsonIgnore
  val sourceUrl = "https://instagram.com/p/$shortcode/"
